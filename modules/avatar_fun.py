...
class AvatarFunPic():
    ...
    @staticmethod
    async def petpet(image: Union[int, str], flip=False, squish=0, fps=20):
        """生成PetPet
        ...
        return MessageChain.create([Image(data_bytes=image_bytes)])
    ...
    @staticmethod
    async def kiss(operator_image: Union[int, str], target_image: Union[int, str]):
        """
        ...
        return MessageChain.create([Image(data_bytes=img_content)])

    @staticmethod
    async def ripped(image: Union[int, str]):
        ...
        return MessageChain.create([Image(data_bytes=output.getvalue())])

    @staticmethod
    async def throw(image: Union[int, str]):
        avatar = await AvatarFunPic.get_pil_avatar(image)
    ...
    @staticmethod
    async def crawl(image: Union[int, str]):
        avatar = await AvatarFunPic.get_pil_avatar(image)
        mask = IMG.new('L', avatar.size, 0)
        draw = ImageDraw.Draw(mask)
        offset = 1
    ...
    @staticmethod
    async def rub(operator_image: Union[int, str], target_image: Union[int, str]):
    ...
    @staticmethod
    async def support(image: Union[int, str]):
        avatar = await AvatarFunPic.get_pil_avatar(image)
    ...
    @staticmethod
    async def swallowed(image: Union[int, str]):
        avatar = await AvatarFunPic.get_pil_avatar(image)
